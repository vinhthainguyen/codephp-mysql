...
<html>
	<head>
		...
		<title>Edit : Pet Management MYSQL Database</title>
		
	</head>
	
	<body>

		<h2 align="center">Pet Management MYSQL Database</h2>
		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						<label class="control-label">NamePet</label>
						<div class="controls">
					...
					<div class="control-group">
						<label class="control-label">nameMaster</label>
						<div class="controls">
							<input name="nameMaster" type="text" placeholder="" value="<?php echo $data['nameMaster'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="vaccinations" type="text"  placeholder="" value="<?php echo $data['vaccinations'];?>" required>
						</div>
					</div>
