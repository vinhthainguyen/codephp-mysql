...
<html>
	<head>
		...
		<title>Read Tag : Pet Management MYSQL Database</title>
	</head>
					...
					<tr>
						<td  bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">NamePet</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
								<tr>
								...
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">nameMaster</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
								<tr>
									<td align="left" class="lf">vaccinations</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
							</table>
